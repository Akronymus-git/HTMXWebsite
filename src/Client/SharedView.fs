...
let link path name = a [ _href path ] [ Text name ]


let basicPage (_title: string) (_body: XmlNode list) hxRequest =
    ...
    let navbar =
        [ div
              [ _id "navbar" ]
              [ linkBoosted "/" "Home"
                linkBoosted "/about" "About"
                linkBoosted "/randomStuff" "Random stuff"
                link "/discord" "Discord"
                link "/rpg" "Incremental Prototype" ] ]
